...
Route::post('/{user:usrname}/follow',[FollowerController::class,'store'])->name('users.follow');
Route::delete('/{user:usrname}/unfollow',[FollowerController::class,'destroy'])->name('users.unfollow');